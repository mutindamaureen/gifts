...
ALLOWED_HOSTS = ['gifts-production-3791.up.railway.app', 'https://gifts-production-3791.up.railway.app','127.0.0.1']
CSRF_TRUSTED_ORIGINS = ['https://gifts-production-3791.up.railway.app']
